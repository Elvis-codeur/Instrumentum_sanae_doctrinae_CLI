...
from Instrumentum_sanae_doctrinae.web_scraping.sermonindex.audio_sermon import si_download_audio_sermon 
...
def test_audio_sermon_get_speaker_work():
    ...
    async def d():
        ...
        ob =si_download_audio_sermon.SI_Download_ListOfAudioWork(
            "A.W. Tozer",
            material_type,
            root_folder,
            browse_by_type,
