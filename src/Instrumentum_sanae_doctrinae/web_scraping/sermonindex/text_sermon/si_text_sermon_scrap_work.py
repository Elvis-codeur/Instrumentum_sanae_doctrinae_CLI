...
class SermonIndexScrapTextSermonWork(SermonIndexScrapAuthorTopicScripturePage):
...
class SI_ScrapTextSermonWork_ALL(http_connexion.ParallelHttpConnexionWithLogManagement):
